...
#'
#' The data file `roth_ineqmats` represents the Rothenberg hyperplane arrangements
#' that [make_roth_ineqmat()] generates. Just like the file `ineqmats`, for large
#' computations it's faster simply to call on precalculated data rather than to run 
#' [make_roth_ineqmat()] many thousands of times. Thus the object `roth_ineqmats` saves 
#' the inequality matrices for scales of cardinality 1-24, to be called upon by 
#' [get_roth_ineqmat()].
#'
#' @format `roth_ineqmats`
