...
When I'm reasoning geometrically about the 6-D space of heptachords, that's exactly what I
do. I imagine two normal planes intersecting at a line in 3-D space, but I will the picture
really hard to be six dimensional. It's not a great approach.

Fortunately, R can help us visualize the scale-space geometries two or three dimensions at
a time. This won't be a picture of the whole space all at once, but at least it can be an
accurate picture of a subspace, not just a cheerfully vague mental image. This vignette
models using musicMCT to depict a few specific cross-sections of the hyperplane arrangements.
...
commonality could be enough to allow MCT's mathematical model to enrich our understanding
...
* The higher tetrachord's last pitch is thus exactly an octave above the first pitch of the lower.
...
This would create a plane of scales that's parallel to and just slightly offset from the
plane that we will visualize. The points on the planes would correspond to each other 
